...
def can_be_found_updated_and_saved
  ...
  awesome_movie = Movie.find_by title: "Awesome Flick"
  awesome_movie.update(title: "Even Awesomer Flick")
  awesome_movie.save
  awesome_movie
end
...
def can_destroy_a_single_item
  ...
  one_movie = Movie.find_by title: "That One Where the Guy Kicks Another Guy Once"
  one_movie.destroy
end
